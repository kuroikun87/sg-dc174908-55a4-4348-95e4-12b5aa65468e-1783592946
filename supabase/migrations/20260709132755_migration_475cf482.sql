-- ============================================
-- CORREGIR TODAS LAS POLÍTICAS RLS: uid() -> auth.uid()
-- ============================================
...
-- cults
DROP POLICY IF EXISTS cults_insert ON cults;
DROP POLICY IF EXISTS cults_select ON cults;
DROP POLICY IF EXISTS cults_update ON cults;
...
-- ranks
DROP POLICY IF EXISTS ranks_insert ON ranks;
DROP POLICY IF EXISTS ranks_select ON ranks;
DROP POLICY IF EXISTS ranks_update ON ranks;
DROP POLICY IF EXISTS ranks_delete ON ranks;
...
-- punishments
DROP POLICY IF EXISTS punishments_insert ON punishments;
DROP POLICY IF EXISTS punishments_select ON punishments;
DROP POLICY IF EXISTS punishments_update ON punishments;
DROP POLICY IF EXISTS punishments_delete ON punishments;
...
-- hierarchy
DROP POLICY IF EXISTS hierarchy_insert ON hierarchy;
DROP POLICY IF EXISTS hierarchy_select ON hierarchy;
DROP POLICY IF EXISTS hierarchy_delete ON hierarchy;
...
-- fetishes
DROP POLICY IF EXISTS fetishes_insert ON fetishes;
DROP POLICY IF EXISTS fetishes_select ON fetishes;
DROP POLICY IF EXISTS fetishes_update ON fetishes;
DROP POLICY IF EXISTS fetishes_delete ON fetishes;
...
-- fetish_ratings
DROP POLICY IF EXISTS fetish_ratings_insert ON fetish_ratings;
DROP POLICY IF EXISTS fetish_ratings_select ON fetish_ratings;
DROP POLICY IF EXISTS fetish_ratings_update ON fetish_ratings;
DROP POLICY IF EXISTS fetish_ratings_delete ON fetish_ratings;
...
-- session_cards
DROP POLICY IF EXISTS session_cards_insert ON session_cards;
DROP POLICY IF EXISTS session_cards_select ON session_cards;
DROP POLICY IF EXISTS session_cards_update ON session_cards;
DROP POLICY IF EXISTS session_cards_delete ON session_cards;
...
-- beat_patterns
DROP POLICY IF EXISTS beat_patterns_insert ON beat_patterns;
DROP POLICY IF EXISTS beat_patterns_select ON beat_patterns;
DROP POLICY IF EXISTS beat_patterns_update ON beat_patterns;
DROP POLICY IF EXISTS beat_patterns_delete ON beat_patterns;

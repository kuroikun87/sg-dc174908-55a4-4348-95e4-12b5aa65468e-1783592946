...
function DeityMenu() {
  const menuItems = [
    ...
    { icon: <Gift className="w-5 h-5" />, title: "Premios", desc: "Recompensas del culto", href: "/dashboard/premios" },
    { icon: <AlertTriangle className="w-5 h-5" />, title: "Consecuencias", desc: "Castigos y restricciones", href: "/dashboard/consecuencias" },
...
function FollowerMenu() {
  const menuItems = [
    ...
    { icon: <Gift className="w-5 h-5" />, title: "Premios", desc: "Tienda y recompensas", href: "/dashboard/premios" },
    { icon: <AlertTriangle className="w-5 h-5" />, title: "Consecuencias", desc: "Castigos activos", href: "/dashboard/consecuencias" },
